...
public final class WalletConnectSessionPublisher {  
  ...
  public var sessionRejection: AnyPublisher<(SessionProposal, Reason), Never> {
  ...
  public var sessionEvent: AnyPublisher<(event: SessionEvent, sessionTopic: String, chainId: Blockchain?), Never> {
